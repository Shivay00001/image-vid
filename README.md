...
## 🚀 Overview
Welcome to **Shivay00001/image-vid**. This repository contains the source code, configurations, and architecture necessary to run the application securely and efficiently.
...
docker run -d -p 8080:8080 shivay00001/image-vid
```
